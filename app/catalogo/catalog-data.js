...
const pageNames = {
  ...
  46: ['Black Led', 'White Led', 'Titanium', 'Steel', 'Star Fish Led', 'Star Fish', 'Snowstorm Premium', 'Silver Led', 'Silver', 'Santorini', 'Sahara'],
  47: ['River Brown', 'Mountain', 'Metallic', 'Jazz White', 'Dust', 'Concrete', 'Carrara White', 'Brown', 'Beach Led', 'Beach'],
  49: ['Desert Gold', 'Ônix Sentai', 'Ônix Verde', 'Ônix White Wine', 'Ônix Tanzania', 'Ônix Tiger', 'Ônix Sunset', 'Ônix Super White'],
  ...
  56: ['Dark Maze', 'Reale', 'Cremo Delicato', 'Crema M. Standard', 'Crema M. Seleto', 'Crema M. Extra / Ivory', 'Crema M. Clássico', 'Cintilante', 'Paraná M. Serrat', 'Paraná Kronos', 'Fantasy Gray', 'Branco Moura “A”'],
  57: ['Carrara', 'Catacatta Venato', 'Calacatta Ouro', 'Calacatta Mielli', 'Calacatta Cremo', 'Calacatta', 'Calacatoro', 'Bronze Armane', 'Brescia Oniciata', 'Brescia Auraro', 'Branco Volakas', 'Branco T. Primos'],
  ...
  59: ['Black P. Bruto', 'Black Move Escovado', 'Black Line', 'Black and Gold', 'Bege Supreme', 'Bardiglio', 'Athens Wood', 'Ariston Extra', 'Arabescato Vagil', 'Arabescato Orobico', 'Angel White', 'Accona Reale'],
  60: ['Vicenzo', 'San Pellegrino', 'Rafaello', 'White Panda', 'Nero', 'Mystery White', 'Paraná Mil. Macchiato', 'Paraná Mil. Classic', 'Paraná C. Venatto', 'Paraná C. Supremo', 'Paraná C. Prime', 'Paraná C. Milano'],
  61: ['Paraná C. Dalmacia', 'Paraná C. D’Oro', 'Paraná Calacatta', 'Paraná Arabes.', 'Alba Pietra', 'Donatello', 'Calatta Botticelli', 'Travertino', 'Rosa Esp. Santo', 'Rajado Especial', 'Rajado Comum', 'Rajado Claro'],
  62: ['Pinta Verde Extra', 'Pinta Verde Claro', 'Pinta Verde Comum', 'Mármore Pegasus'],
  64: ['Travertino Ocean Grey', 'Limestone Valverde', 'Limestone Royale', 'Niwala Yellow', 'Limestone Baccarat'],
  66: ['Calacatta Bra. MB27', 'White Macaúbas MB28', 'Taj Mahal OC10', 'Hyle', 'Holos', 'Tundra Selec MB13', 'Travertino Bianco SE13', 'Travertino Chiaro SE09', 'Travertino Grey', 'Skov WD02', 'Statuario Principe MB21', 'Sahara Noir MB10'],
